...
bcftools query -f '[%GT\t]\n' \
/home/jl430796/MaizePop/data/processed/04_XP_EHH/XP_EHH_1/chr${chr}_Iodent_1.vcf.gz \
| awk '
{
    for(i=1; i<=NF; i++) {
        split($i,a,"|");
...
}' > /home/jl430796/MaizePop/data/processed/04_XP_EHH/XP_EHH_2/chr${chr}_Iodent_1.hap
