Pv_Tr <- read.table("C:/Users/kjlis/Desktop/maize_selection/XP_CLR_data/XP_CLR_Pv_Tr_smoothed.csv", sep = ",", header=TRUE)
Tr_Idt_1 <- read.table("C:/Users/kjlis/Desktop/maize_selection/XP_CLR_data/XP_CLR_Tr_Idt_1_smoothed.csv", sep = ",", header=TRUE)
Tr_SS_1 <- read.table("C:/Users/kjlis/Desktop/maize_selection/XP_CLR_data/XP_CLR_Tr_SS_1_smoothed.csv", sep = ",", header=TRUE)
Idt_1vs2 <- read.table("C:/Users/kjlis/Desktop/maize_selection/XP_CLR_data/XP_CLR_Idt_1vs2_smoothed.csv", sep = ",", header=TRUE)
SS_1vs2 <- read.table("C:/Users/kjlis/Desktop/maize_selection/XP_CLR_data/XP_CLR_SS_1vs2_smoothed.csv", sep = ",", header=TRUE)
