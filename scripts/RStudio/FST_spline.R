...
threshold_Pv_Tr <- quantile(Pv_Tr$Wstat, 0.90, na.rm = TRUE)
...
threshold_Tr_Idt_1 <- quantile(Tr_Idt_1$Wstat, 0.90, na.rm = TRUE)
...
threshold_Tr_SS_1 <- quantile(Tr_SS_1$Wstat, 0.90, na.rm = TRUE)
...
threshold_Idt_1vs2 <- quantile(Idt_1vs2$Wstat, 0.90, na.rm = TRUE)
...
threshold_SS_1vs2 <- quantile(SS_1vs2$Wstat, 0.90, na.rm = TRUE)
