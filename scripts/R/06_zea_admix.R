Q <- read.table("/home/kuba/Desktop/full/full/zea_admix/chr_all_plink_3.5.Q")

metadane <- read.csv("/home/kuba/Desktop/zea_metadane.csv", header=T)
...
write.csv(merged, "/home/kuba/Desktop/zea_admix_5.csv", row.names=FALSE)
table(merged$Assigned_cluster)

polish_lines <- merged[merged$origin == "Poland", ]
write.csv(polish_lines, "/home/kuba/Desktop/zea_admix_5_PL.csv", row.names=FALSE)
